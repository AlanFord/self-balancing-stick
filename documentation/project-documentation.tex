...
\nomenclature[O]{\(T\)}{the total motor torque (N m)}
...
\todo{the control function is missing}Using \eqref{EQ.simpleController}, \eqref{franco}, \eqref{groucho}, and \eqref{rondoMucho}, the open loop transfer function is now
\begin{equation}
...
The initial reaction wheel design was modeled after XXXX\todo{fix this}, with modifications to allow the reaction wheel
