...
// purpose: This is a test routine that will demonstrate proper encoder speed
//          and direction outputs.  The motors will be driven via the motor drivers,
//          with the speed stepping through a range and then reversing direction.
//          It is suggested that the motors be powered with a voltage such that the
//          motor speed is not excessive.  Attach a tape "flag" to the motor shaft or
//          reaction wheel to ease determination of rotation direction.
//////////////////////////////////////////////
